...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\Column]
    private ?\DateTimeImmutable $lastApiCalledAt = null;
    ...
    public function getLastApiCalledAt(): ?\DateTimeImmutable
    {
        return $this->lastApiCalledAt;
    }

    #[Groups(['users:read'])]
    #[SerializedName('lastApiCalledAt')]
    public function getLastApiCalledAtAgo(): ?string
    {
        return Carbon::instance( $this->lastApiCalledAt)->diffForHumans();
    }

    public function setLastApiCalledAt(\DateTimeImmutable $lastApiCalledAt): self
    {
        $this->lastApiCalledAt = $lastApiCalledAt;
